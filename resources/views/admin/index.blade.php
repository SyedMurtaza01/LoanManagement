...
<div class="container-fluid">
        ...
        <div class="col-sm-6">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Micro Loan Management</a></li>
        ...
        <div class="card mini-stat bg-primary">
            <div class="card-body mini-stat-img">
                <div class="mini-stat-icon">
                    <i class="mdi mdi-account-group float-end"></i> <!-- Updated icon -->
                </div>
                <div class="text-white">
                    <h6 class="text-uppercase mb-3 font-size-16 text-white">Users</h6>
                    <h2 class="mb-4 text-white">{{ $count }}</h2>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card mini-stat bg-primary">
            <div class="card-body mini-stat-img">
                <div class="mini-stat-icon">
                    <i class="mdi mdi-office-building float-end"></i> <!-- Updated icon -->
                </div>
                <div class="text-white">
                    <h6 class="text-uppercase mb-3 font-size-16 text-white">Branches</h6>
                    <h2 class="mb-4 text-white">{{ $branch }}</h2>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card mini-stat bg-primary">
            <div class="card-body mini-stat-img">
                <div class="mini-stat-icon">
                    <i class="mdi mdi-file-outline float-end"></i> <!-- Updated icon -->
                </div>
                <div class="text-white">
                    <h6 class="text-uppercase mb-3 font-size-16 text-white">Plans</h6>
                    <h2 class="mb-4 text-white">{{ $plan }}</h2>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card mini-stat bg-primary">
            <div class="card-body mini-stat-img">
                <div class="mini-stat-icon">
                    <i class="mdi mdi-cash-multiple float-end"></i> <!-- Updated icon -->
                </div>
                <div class="text-white">
                    <h6 class="text-uppercase mb-3 font-size-16 text-white">Installment</h6>
                    <h2 class="mb-4 text-white">{{ $installment }}</h2>
